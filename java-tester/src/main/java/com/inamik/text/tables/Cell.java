...
import com.inamik.text.tables.cell.base.*;
import com.inamik.text.tables.line.*;
...
public final class Cell {
    ...
    public static abstract class Function {
        public static final Function IDENTITY = new Function() {
            ...
            @Override
            public Collection<String> apply(Integer _1, Integer _2, Collection<String> cell) {
                return cell;
            }
        ...
        private static Function of(final FunctionWithCharAndWidthAndHeight f, final Character character, final Integer width, final Integer height) {
            return new Function() {
                ...
                public Function withChar(char character) {
                    return of(f, character, width, height);
                }
    ...
    public static abstract class FullPadding extends Function {
        ...
        public static FullPadding of(final int leftPad, final int rightPad, final int topPad, final int bottomPad, final Character character, final Integer width, final Integer height) {
            return new FullPadding() {
                @Override
                public FullPadding fullPad(int pad) {
                    return of(pad, pad, pad, pad, character, width, height);
                }

                @Override
                public FullPadding leftPad(int leftPad) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }

                @Override
                public FullPadding rightPad(int rightPad) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }

                @Override
                public FullPadding topPad(int topPad) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }

                @Override
                public FullPadding bottomPad(int bottomPad) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }

                @Override
                public FullPadding withChar(char character) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }

                @Override
                public FullPadding withWidth(int width) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }

                @Override
                public FullPadding withHeight(int height) {
                    return of(leftPad, rightPad, topPad, bottomPad, character, width, height);
                }
